...
colors\_and\_type.css — drop-in CSS variables for color, typography, radius, shadow, and spacing
...
ui\_kits/dashboard/index.html — full dashboard UI kit reference for layout, hierarchy, and density
